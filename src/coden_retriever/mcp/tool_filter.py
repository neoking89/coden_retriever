...
TOOL_QUERY_DESCRIPTIONS: dict[str, str] = {
    ...
    "architectural_bottlenecks": "Function-level bridges: rank functions by betweenness, find bottlenecks on many call paths",
    "architecture": "Package-level audit: cycles, kitchen-sinks, oversized files, shallow packages, structural debt",
